...
AskForObjective:
    ...
    else ; todo if not empty
    {
        ...
        ; GuiControl Alpha:Text, ObjectiveMessage, %UserInput%
        ; GuiControl Alpha:Move, ObjectiveMessage, % "h" newtextH "w" newtextW
        ; Gui, Alpha:Add, Text, , % "h" newtextH " w" newtextW " y" newtextY " x" newtextX
...
; CalcTextSize(newText) {

;     global GuiFontColor, GuiFontSize, GuiFont, pseudotext
;     Gui PseudoGui:New
;     Gui, PseudoGui:Font, %GuiFontColor% %GuiFontSize% %GuiFont%
;     Gui, PseudoGui:Add, Text, vpseudotext, %newText%
;     GuiControlGet, pseudoCoords, PseudoGui:Pos, pseudotext
;     temp := pseudoCoords
;     Gui PseudoGui:Show
;     Gui PseudoGui:Destroy
;     return pseudoCoords
